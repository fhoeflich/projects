...
RTCFUNC(get,ds1743)(struct tm *tm, int cent_reg) {
	...
	mon		= chip_read8(DS1743_MONTH) & DS1743_MONTH_MASK;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/hardware/branches/release/utils/r/rtc/clk_ds1743.c $ $Rev: 680331 $")
#endif
