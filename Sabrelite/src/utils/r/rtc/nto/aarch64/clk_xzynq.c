...
#define XZYNQ_RTC_BASE          0xFFA60000
...
/* NOTE: using the calibration value mentioned in the Ultrascale TRM (ug1085),
...
/*
 * Clock setup for the RTC on the Ultrascale SoC.
 */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/hardware/branches/release/utils/r/rtc/nto/aarch64/clk_xzynq.c $ $Rev: 928459 $")
#endif
