...
#define PL030_RTCDR     0x00    /* data register */
#define PL030_RTCLR     0x0c    /* counter load register */
#define PL030_RTCCR     0x10    /* control register */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/hardware/branches/release/utils/r/rtc/clk_primecell.c $ $Rev: 982741 $")
#endif
