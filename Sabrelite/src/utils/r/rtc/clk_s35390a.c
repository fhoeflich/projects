...
RTCFUNC(set,s35390)(struct tm *tm, int cent_reg)
{
    ...
    if (status & S35390_STS_24HR)
	    ...
	    date[S35390_HOUR]  = (tm->tm_hour < 12) ? BIN2BCD(tm->tm_hour) : (S35390_RTD_PM | BIN2BCD(tm->tm_hour - 12));
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/hardware/branches/release/utils/r/rtc/clk_s35390a.c $ $Rev: 680331 $")
#endif
