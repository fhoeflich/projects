/*
 * $QNXLicenseC:
 * Copyright 2007,2009, 2022 BlackBerry Limited.
...
#define RSRCDBMGR_DMA_CH_START      (SDMA_N_CH * SDMA_INSTANCE)
...
#define SDMA_CHTYPE_MCU_2_SSISH     9
#define SDMA_CHTYPE_SSISH_2_MCU     10
#define SDMA_CHTYPE_MCU_2_SSIAPP    11
#define SDMA_CHTYPE_SSIAPP_2_MCU    12
#define SDMA_CHTYPE_ZQSPI_2_MCU     13
...
#define SDMA_CMD_COMPLETE_PULSE_CODE       (_PULSE_CODE_MINAVAIL+1)
#define SDMA_CMD_TIMOUT_NS                  1000000000  // 1sec

#define SDMA_EVENT_PULSE_CODE              (_PULSE_CODE_MINAVAIL+2)
#define SDMA_PULSE_CODE_EXIT               (_PULSE_CODE_MINAVAIL+3)
...
typedef struct {
    sdma_bd_t  cmd_chn_bd;
    uint32_t   reserved[13];
    sdma_ccb_t ccb[SDMA_N_CH];
} sdma_dma_mem_t;
...
typedef struct {
    ...
    unsigned runtime_ctx;
    unsigned runtime_ctx_loaded;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/hardware/branches/release/lib/dma/sdma/sdma.h $ $Rev: 972859 $")
#endif
