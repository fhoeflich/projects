...
#define IMX_DMA_CHANNEL_SIZE (sizeof(IMX_eDMA_Channel_t))
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/hardware/branches/release/lib/dma/public/soc/nxp/imx8/common/imx_edma_channel.h $ $Rev: 965835 $")
#endif
