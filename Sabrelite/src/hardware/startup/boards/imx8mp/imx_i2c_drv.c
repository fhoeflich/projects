...
// For master RX
static int rx_byte(unsigned char *data, const unsigned int base)
{
    unsigned short i2cr;
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/hardware/branches/release/hardware/startup/boards/imx8mp/imx_i2c_drv.c $ $Rev: 989175 $")
#endif
