...
/* PCIe ATU memory mapped (unrolled) registers */
#define IMX_PCIE_UNR_iATU_REGION_CTRL1  0x00      /* iATU Region Control 1 Register */
#define IMX_PCIE_UNR_iATU_REGION_CTRL2  0x04      /* iATU Region Control 2 Register */
#define IMX_PCIE_UNR_iATU_LOWER_BASE    0x08      /* iATU Lower Base Address Register */
#define IMX_PCIE_UNR_iATU_UPPER_BASE    0x0C      /* iATU Upper Base Address Register */
#define IMX_PCIE_UNR_iATU_LIMIT         0x10      /* iATU Limit Address Register */
#define IMX_PCIE_UNR_iATU_LOWER_TARGET  0x14      /* iATU Lower Target Address Register */
#define IMX_PCIE_UNR_iATU_UPPER_TARGET  0x18      /* iATU Upper Target Address Register */

/*
 * Control Register 2 bits
 */
#define IMX_PCIE_PL_DEBUG1_LINK_UP                  (0x01 << 4)      /* xmlh_link_up LTSSM reports PHY link up */
#define IMX_PCIE_PL_DEBUG1_LINK_IN_TRAINING         (0x01 << 29)     /* PHY link in training */
...
#define IMX_PCIE_UNR_iATU_OUTBOUND_REG_OFFSET(n)    (0x0300000UL | \
                                                    ((n) << 9))        /* Calculate iATU outbound register offset */
#define IMX_PCIE_UNR_iATU_INBOUND_REG_OFFSET(n)     (0x0300100UL | \
                                                    ((n) << 9))        /* Calculate iATU inbound register offset  */
