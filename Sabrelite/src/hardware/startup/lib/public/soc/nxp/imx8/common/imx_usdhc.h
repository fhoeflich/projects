...
/* Field RTR - Re-Tuning Request (only for SD3.0 SDR104 mode and EMMC HS200 mode) */
...
/* Field RTE - Re-Tuning Event: (only for SD3.0 SDR104 mode and EMMC HS200 mode) */
...
/* Field TP - Tuning Pass:(only for SD3.0 SDR104 mode and EMMC HS200 mode) */
#define IMX_USDHC_INT_STATUS_TP_SHIFT           13
#define IMX_USDHC_INT_STATUS_TP_MASK            0x2000
#define IMX_USDHC_INT_STATUS_TP(v)              (((v) << 0xD) & 0x2000)
/* Field CQI - Command Queuing Interrupt */
#define IMX_USDHC_INT_STATUS_CQI_SHIFT          14
#define IMX_USDHC_INT_STATUS_CQI_MASK           0x4000
#define IMX_USDHC_INT_STATUS_CQI(v)             (((v) << 0xE) & 0x4000)
...
/* Field TNE - Tuning Error: (only for SD3.0 SDR104 mode and EMMC HS200 mode) */
...
#define IMX_USDHC_INT_STATUS_EN_TPSEN_SHIFT     13
#define IMX_USDHC_INT_STATUS_EN_TPSEN_MASK      0x2000
#define IMX_USDHC_INT_STATUS_EN_TPSEN(v)        (((v) << 0xD) & 0x2000)
/* Field CQISEN - Command Queuing Status Enable */
#define IMX_USDHC_INT_STATUS_EN_CQISEN_SHIFT    14
#define IMX_USDHC_INT_STATUS_EN_CQISEN_MASK     0x4000
#define IMX_USDHC_INT_STATUS_EN_CQISEN(v)       (((v) << 0xE) & 0x4000)
...
#define IMX_USDHC_INT_SIGNAL_EN_TPIEN_SHIFT     13
#define IMX_USDHC_INT_SIGNAL_EN_TPIEN_MASK      0x2000
#define IMX_USDHC_INT_SIGNAL_EN_TPIEN(v)        (((v) << 0xD) & 0x2000)
/* Field CQIIEN - Command Queuing Signal Enable */
#define IMX_USDHC_INT_SIGNAL_EN_CQIIEN_SHIFT    14
#define IMX_USDHC_INT_SIGNAL_EN_CQIIEN_MASK     0x4000
#define IMX_USDHC_INT_SIGNAL_EN_CQIIEN(v)       (((v) << 0xE) & 0x4000)
...
/* Field EXE_TUNE - Execute Tuning: (Only used for SD3.0, SDR104 mode and EMMC HS200 mode) */
...
/* Field SMP_CLK_SEL - Select clock to sample data: (Only used for SD3.0, SDR104 mode and EMMC HS200 mode) */
 ...
 * (Only used for SD3.0, SDR104 mode and and EMMC HS200 mode) */
...
/* Field HS400ES_MODE - Enable enhance HS400 Mode */
#define IMX_USDHC_MIX_CTRL_EN_HS400_MODE_SHIFT  27
#define IMX_USDHC_MIX_CTRL_EN_HS400_MODE_MASK   0x8000000
#define IMX_USDHC_MIX_CTRL_EN_HS400_MODE(v)     (((v) << 27) & 0x8000000)
/* Field HS400ES_MODE - Enable enhance HS400 Mode */
#define IMX_USDHC_MIX_CTRL_RESERVED31_SHIFT     31
#define IMX_USDHC_MIX_CTRL_RESERVED31_MASK      0x80000000
#define IMX_USDHC_MIX_CTRL_RESERVED31(v)        (((v) << 31) & 0x80000000)
...
#define IMX_USDHC_STROBE_DLL_CTRL_SLV_DLY_TARGET_MASK  0x78
#define IMX_USDHC_STROBE_DLL_CTRL_SLV_DLY_TARGET(v)    (((v) << 0x3) & 0x78)
/* Value 7 sets the sampling point to the middle of the sampling window */
#define IMX_USDHC_STROBE_DLL_CTRL_SLV_DLY_TARGET_DEFAULT_VALUE 7
/* Field STROBE_DLL_CTRL_GATE_UPDATE - Strobe DLL Control Gate Update */
#define IMX_USDHC_STROBE_DLL_CTRL_GATE_UPDATE_SHIFT 7
#define IMX_USDHC_STROBE_DLL_CTRL_GATE_UPDATE_MASK  0x80
#define IMX_USDHC_STROBE_DLL_CTRL_GATE_UPDATE_(v)    (((v) << 0x7) & 0x80)
...
#define IMX_USDHC_STROBE_DLL_CTRL_SLV_UPDATE_INT_DEFAULT_VALUE 4
...
/* Field ACMD23_ARGU2_EN - Argument2 register enable for ACMD23 sharing with SDMA system address register */
#define IMX_USDHC_VEND_SPEC2_ACMD23_ARGU2_EN_SHIFT      12
#define IMX_USDHC_VEND_SPEC2_ACMD23_ARGU2_EN_MASK       0x1000
#define IMX_USDHC_VEND_SPEC2_ACMD23_ARGU2_EN(v)         (((v) << 12) & 0x1000)
/* Field PART_DLL_DEBUG - Use to debug for part dll */
#define IMX_USDHC_VEND_SPEC2_PART_DLL_DEBUG_SHIFT       13
#define IMX_USDHC_VEND_SPEC2_PART_DLL_DEBUG_MASK        0x2000
#define IMX_USDHC_VEND_SPEC2_PART_DLL_DEBUG(v)          (((v) << 13) & 0x2000)
/* Field BUS_RST - Reset internal bus logic before RST_ALL or RST_DATA to avoid bus hang */
#define IMX_USDHC_VEND_SPEC2_BUS_RST_SHIFT              14
#define IMX_USDHC_VEND_SPEC2_BUS_RST_MASK               0x4000
#define IMX_USDHC_VEND_SPEC2_BUS_RST(v)                 (((v) << 14) & 0x4000)
/* Field EN_32K_CLK - Enable 32khz clock for card detection */
#define IMX_USDHC_VEND_SPEC2_EN_32K_CLK_SHIFT           15
#define IMX_USDHC_VEND_SPEC2_EN_32K_CLK_MASK            0x8000
#define IMX_USDHC_VEND_SPEC2_EN_32K_CLK(v)              (((v) << 15) & 0x8000)
/* Field FBCLK_TAP_SEL - Enable extra delay on internal feedback clock */
#define IMX_USDHC_VEND_SPEC2_FBCLK_TAP_SEL_SHIFT        16
#define IMX_USDHC_VEND_SPEC2_FBCLK_TAP_SEL_MASK         0xFFFF0000
#define IMX_USDHC_VEND_SPEC2_FBCLK_TAP_SEL(v)           (((v) << 16) & 0xFFFF0000)
...
#define IMX_USDHC_TUNING_CTRL_TUNING_START_TAP_MASK  0x7F
#define IMX_USDHC_TUNING_CTRL_TUNING_START_TAP(v)    (((v) << 0) & 0x7F)
#define IMX_USDHC_TUNING_CTRL_TUNING_START_TAP_DEFAULT 20
/* Field DIS_CMD_CHK_FOR_STD_TUNING - Disable command check for standard tuning */
#define IMX_USDHC_TUNING_CTRL_DIS_CMD_CHK_FOR_STD_TUNING_SHIFT 7
#define IMX_USDHC_TUNING_CTRL_DIS_CMD_CHK_FOR_STD_TUNING_MASK  0x80
#define IMX_USDHC_TUNING_CTRL_DIS_CMD_CHK_FOR_STD_TUNING(v)    (((v) << 7) & 0x80)
...
#define IMX_USDHC_TUNING_CTRL_TUNING_STEP_DEFAULT 2
...
/* Register HOST_CTRL_VER - Host Controller Version */
#define IMX_USDHC_HOST_CTRL_VER                 0xFC
/* Host controller version mask*/
#define IMX_USDHC_HOST_CTRL_VER_SVN_MASK        0xFF
/* Specification Version Number */
#define IMX_USDHC_HOST_CTRL_VER_SVN_BV_VER_3    0x2 /* SD Host Specification Version 3.0. (Supports Test Event Register and ADMA) */
#define IMX_USDHC_HOST_CTRL_VER_SVN_BV_VER_1    0x0 /* SD Host Specification Version 1.0. */



/* Register CQE - Command Queue Register */
#define IMX_USDHC_CQE                           0x100
