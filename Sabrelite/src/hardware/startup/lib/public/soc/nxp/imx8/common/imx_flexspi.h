...
/*!
 * @file imx_flexspi.h
 * @brief FlexSPI memory map for for i.MX
 *
 * FlexSPI memory map for for i.MX
 */
...
#define IMX_FLEXSPI_MCR0_RXCLKSRC(v)                (((v) << 4) & IMX_FLEXSPI_MCR0_RXCLKSRC_MASK)
#define IMX_FLEXSPI_MCR0_RXCLKSRC_BV_LPBK_INT       0
#define IMX_FLEXSPI_MCR0_RXCLKSRC_BV_LPBK_DQS       1
#define IMX_FLEXSPI_MCR0_RXCLKSRC_BV_FLSH_DQS       3
...
#define IMX_FLEXSPI_IPRXFSTS_FILL_MASK              (0xFF << 0)
...
#define IMX_FLEXSPI_IPTXFSTS_FILL_MASK              (0xFF << 0)
