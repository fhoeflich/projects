...
/* Field RW_SW_RESET - RW software reset */
#define IMX_USB3_NON_CORE_CORE_CTRL11_RW_SW_RESET_SHIFT 28
#define IMX_USB3_NON_CORE_CORE_CTRL11_RW_SW_RESET_MASK 0x10000000
#define IMX_USB3_NON_CORE_CORE_CTRL11_RW_SW_RESET(v) (((v) << 28) & 0x10000000)
...
#define IMX_USB3_NON_CORE_ALL_SW_RESET    (IMX_USB3_NON_CORE_CORE_CTRL11_PWR_SW_RESET_MASK | IMX_USB3_NON_CORE_CORE_CTRL11_APB_SW_RESET_MASK | \
                                           IMX_USB3_NON_CORE_CORE_CTRL11_AXI_SW_RESET_MASK | IMX_USB3_NON_CORE_CORE_CTRL11_RW_SW_RESET_MASK | \
                                           IMX_USB3_NON_CORE_CORE_CTRL11_PHY_SW_RESET_MASK | IMX_USB3_NON_CORE_CORE_CTRL11_PHYAPB_SW_RESET_MASK)
