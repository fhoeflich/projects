...
#define IMX_AIPS5_CONFIG_BASE                   0x30DF0000

/*
 * Boot information for software
 */
#define IMX_BOOT_INFORMATION_BASE               0x000009E8
 ...
 * Ethernet QOS
 */
#define IMX_ENET_QOS_BASE                      0x30BF0000
#define IMX_ENET_QOS_MEM_SIZE                  0x10000

#define IMX_ENET_QOS_IRQ                       167
 ...
 */
#define IMX_HSIO_BASE                          0x32F10000
#define IMX_HSIO_SIZE                          0x10000

/*
 * High Assurance Boot (HAB)
 */
#define IMX_HAB_RVT_BASE                       0x00000900UL

/* HAB functions */
#define IMX_HAB_RVT_ENTRY_OFFSET               0x08
#define IMX_HAB_RVT_EXIT_OFFSET                0x10
#define IMX_HAB_RVT_CHECK_TARGET_OFFSET        0x18
#define IMX_HAB_RVT_AUTHENTICATE_IMAGE_OFFSET  0x20
#define IMX_HAB_RVT_REPORT_EVENT_OFFSET        0x40
#define IMX_HAB_RVT_REPORT_STATUS_OFFSET       0x48
#define IMX_HAB_RVT_FAILSAFE_OFFSET            0x50
/* Security Configuration Mode */
#define IMX_HAB_SEC_CONFIG                     0x450
#define IMX_HAB_SEC_CONFIG_ENABLE_BIT          0x2000000
...
#define IMX_IOMUXC_GPR_SIZE                    0x10000
...
#define IMX_I2C2_BASE                          0x30A30000
#define IMX_I2C3_BASE                          0x30A40000
#define IMX_I2C4_BASE                          0x30A50000

#define IMX_I2C1_IRQ                           (35 + 32)
#define IMX_I2C2_IRQ                           (36 + 32)
#define IMX_I2C3_IRQ                           (37 + 32)

#define IMX_I2C_SIZE                           0x10000
#define IMX_I2C_COUNT                          4

/*
 * Controller Area Network (CAN)
 */
#define IMX_FLEXCAN0_REG_BASE                  0x308C0000
#define IMX_FLEXCAN1_REG_BASE                  0x308D0000
#define IMX_FLEXCAN0_MEM_BASE                  0x308C0080
#define IMX_FLEXCAN1_MEM_BASE                  0x308D0080

#define IMX_FLEXCAN0_IRQ                       (142 + 32)
#define IMX_FLEXCAN1_IRQ                       (144 + 32)

#define IMX_FLEXCAN_COUNT                      2
...
#define IMX_DDR_SS_GRP0_BASE                   0x3D000000
#define IMX_DDR_CTL_BASE                       0x3D400000

/*
 * PCI Express (PCIe)
 */
#define IMX_PCIE1_BASE                         0x33800000
#define IMX_PCIE_SIZE                          0x400000

#define IMX_PCIE1_IRQ_A                        158
#define IMX_PCIE1_IRQ_B                        157
#define IMX_PCIE1_IRQ_C                        156
#define IMX_PCIE1_IRQ_D                        155
#define IMX_PCIE1_MSI                          155

#define IMX_PCIE1_PHY_BASE                     0x32F00000
#define IMX_PCIE_PHY_SIZE                      0x10000

/*
 * USB
 */
#define IMX_USB3_OTG1_BASE                     0x38100000
#define IMX_USB3_OTG1_IRQ                      72
#define IMX_USB3_OTG1_SIZE                     0x10000

#define IMX_USB3_OTG2_BASE                     0x38200000
#define IMX_USB3_OTG2_IRQ                      73
#define IMX_USB3_OTG2_SIZE                     0x10000
 ...
 */
#define IMX_SAI1_BASE                          0x30C10000
#define IMX_SAI2_BASE                          0x30C20000
#define IMX_SAI3_BASE                          0x30C30000
#define IMX_SAI5_BASE                          0x30C50000
#define IMX_SAI6_BASE                          0x30C60000

#define IMX_SAI1_IRQ                           (95 + 32)
...
/* SDMA2 mappings */
#define IMX_SAI1_RX_EVENT                      0
#define IMX_SAI1_TX_EVENT                      1
...
#define IMX_SNVS_SIZE                          0x10000

/* Audio Block Control */
#define IMX_AUDIO_BLK_CTRL                     0x30E20000
#define IMX_AUDIO_BLK_CTRL_SIZE                0x10000

/* eDMA for memory-2-memory only */
#define IMX_EDMA1_BASE                          0x30E30000
#define IMX_EDMA1_CHN_LOW_IRQ                   (132 + 32)
#define IMX_EDMA1_CHN_HI_IRQ                    (133 + 32)
#define IMX_EDMA1_ERROR_IRQ                     (131 + 32)

/* HDMI */
#define IMX_HDMI_IRQ                            75
#define IMX_IRQ_STEER_HDMI_BASE                 0x32FC2000
