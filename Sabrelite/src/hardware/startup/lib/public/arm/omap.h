...
/* Bit definitions for CTRL_STATUS */
#define HDQ_CTRL_STATUS_MODE                0x01
#define HDQ_CTRL_STATUS_DIR                 0x02
#define HDQ_CTRL_STATUS_INITIALIZATION      0x04
#define HDQ_CTRL_STATUS_PRESENCEDETECT      0x08
#define HDQ_CTRL_STATUS_GO                  0x10
#define HDQ_CTRL_STATUS_CLOCKENABLE         0x20
#define HDQ_CTRL_STATUS_INTERRUPTMASK       0x40
#define HDQ_CTRL_STATUS_ONE_WIRE_SINGLE_BIT 0x80

/* Bit definitions for INT_STATUS */
#define HDQ_INT_STATUS_TIMEOUT              0x01
#define HDQ_INT_STATUS_RXCOMPLETE           0x02
#define HDQ_INT_STATUS_TXCOMPLETE           0x04

/* Bit definitions for SYSCONFIG */
#define HDQ_SYSCONFIG_AUTOIDLE              0x01
#define HDQ_SYSCONFIG_SOFTRESET             0x02

/* Bit definitions for SYSSTATUS */
#define HDQ_SYSSTATUS_RESETDONE             0x01
...
/* __SRCVERSION("omap.h $Rev: 716263 $"); */
