...
#define ECSD_PART_CONFIG            179
    #define ECSD_PART_CONFIG_BOOT_PARTITION_ENABLE_SHIFT 3
    #define ECSD_PART_CONFIG_BOOT_PARTITION_ENABLE_MASK  (0x7 << 3)
...
#endif /* _MMC_H_INCLUDED */

#if defined(__QNXNTO__) && defined(__USESRCVERSION)
#include <sys/srcversion.h>
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/hardware/branches/release/hardware/ipl/lib/sdmmc/mmc.h $ $Rev: 980070 $")
#endif
