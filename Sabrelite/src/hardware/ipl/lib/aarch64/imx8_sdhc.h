...
#ifndef _IMX8_SDHC_INCLUDED
#define _IMX8_SDHC_INCLUDED
...
#define IMX_USDHC_TUNING_START_TAP_DFLT 1
...
#define IMX_USDHC_MANUAL_TUNING_ESS     5        /* Manual Tuning effective sample size */

// 32 bit ADMA descriptor defination
typedef struct _imx8_adma32_t {
    uint16_t    attr;
    uint16_t    len;
    uint32_t    addr;
} imx8_adma32_t;

#define SDMA_MAX_BCNT                   65535
...
#define IMX_USDHC_USE_SDMA              (1 << 0)
#define IMX_USDHC_USE_ADMA              (1 << 1)
#define IMX_USDHC_TUNING_MANUAL         (1 << 3)
#define IMX_USDHC_TUNING_STANDARD       (1 << 4)
#define IMX_USDHC_TUNING_MASK           (IMX_USDHC_TUNING_MANUAL | IMX_USDHC_TUNING_STANDARD)

#endif /* #ifndef _MX_SDHC_INCLUDED */

#if defined(__QNXNTO__) && defined(__USESRCVERSION)
#include <sys/srcversion.h>
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/hardware/branches/release/hardware/ipl/lib/aarch64/imx8_sdhc.h $ $Rev: 979772 $")
#endif
