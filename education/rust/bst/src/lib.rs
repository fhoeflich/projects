    ...
    T: Ord,
{
	...
	// Return a new iterator which iterates over the tree in order
	...
	// Return the largest value in the tree smaller than value
	...
	// Return the smallest value in the tree larger than value
...
mod test {
    ...
    // #[test] 		// can't specify attribute here, will cause error
					// due to returning the BST
